            ...
            switch (_a.label) {
                case 0:
                    ...
                    getAllData = function (lastPinId) { return __awaiter(_this, void 0, void 0, function () {
                        var pageData, parsedData, imgKeys, pinId;
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                ...
                                case 2:
                                    parsedData = _a.sent();
                                    imgKeys = parsedData.imgKeys, pinId = parsedData.lastPinId;
                                    if (imgKeys.length) {
                                        keys.push.apply(keys, imgKeys);
                                        getAllData(pinId);
                                    }
                                    return [2 /*return*/];
                            }
                ...
                case 1:
                    _a.sent();
                    return [2 /*return*/, convertKeysToLinks(keys)];
            }
        });
    });
}
