 ...
 */
function getData(boardId, lastPinId) {
...
module.exports = /** @class */ (function () {
     ...
     * @param data 数据
     */
    Board.prototype.parsePageData = function (data) {
        var _a, _b;
        // 标题、pins
    ...
    Board.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, getData(this.id)];
                    case 1:
                        data = _a.sent();
                        return [4 /*yield*/, this.parsePageData(data)];
                    case 2:
                        _a.sent();
                        this.page = 1;
                        this.status = INITED;
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, getData(this.id, this.lastPinId)];
                    case 1:
                        data = _a.sent();
                        pageData = this.parsePageData(data);
